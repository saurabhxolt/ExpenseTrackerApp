...
- **Phase 7: Pluggable On-Device AI Engine** — ⏳ ARCHITECTURE DESIGNED
  - Abstract `AiEngine` plugin interface for Gemma, Phi, Qwen, and MediaPipe on-device LLM models with hardware detection and offline inference.
- **Phase 8: PDF Export & Investments** — ⏳ PLANNED
